(() => {
    ...
    const floating = ext.shared.floating;
                    ...
                    ? items.map((item) => {
                        ...
                        return `
                            <div class="gesture-clipboard-item">
                                <div class="gesture-clipboard-item-text">${previewText(escaped)}</div>
                                <div class="gesture-clipboard-item-actions">
                                    <button type="button" class="gesture-clipboard-action" data-insert="${encoded}">Chèn</button>
                                    <button type="button" class="gesture-clipboard-action" data-pin="${encoded}">${title === 'Đã ghim' ? 'Bỏ ghim' : 'Ghim'}</button>
                                    <button type="button" class="gesture-clipboard-action gesture-clipboard-action-danger" data-remove="${encoded}">Xóa</button>
                                </div>
                            </div>
                        `;
                    }).join('')
